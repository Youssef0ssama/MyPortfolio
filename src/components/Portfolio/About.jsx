        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-6">
                ...
                <CardContent className="p-0">
                  ...
                  <div className="bg-gray-800/80 p-4 border-b border-gray-700">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-gray-400 text-sm ml-4 font-mono">developer-profile.js</span>
                    </div>
                  </div>
              ...
              {/* Mission Card */}
              <Card className="bg-gradient-to-r from-cyan-500/10 to-purple-500/10 border border-cyan-500/30 backdrop-blur-sm">
                <CardContent className="p-6">
                  <div className="flex items-center mb-4">
                    <Target className="w-6 h-6 text-cyan-400 mr-3" />
                    <h3 className="text-xl font-bold text-white font-mono">Mission Statement</h3>
                  </div>
            ...
            <div className="space-y-6">
              {/* Education Card */}
              <Card className="bg-gray-900/90 backdrop-blur-sm border border-gray-700 hover:border-blue-500/50 transition-all duration-300">
                <CardContent className="p-6">
                  <div className="flex items-center mb-6">
                    ...
                    <div>
                      <h3 className="text-xl font-bold text-white font-mono">Education</h3>
                      <p className="text-gray-400 font-mono text-sm">Academic Background</p>
                    </div>
                  </div>
                  ...
                  <div className="bg-black/30 rounded-lg p-4 border border-gray-700">
                    ...
                    <div className="flex items-center text-gray-400 mb-4 font-mono">
                  ...
                  <div className="mt-4">
                    <h5 className="font-semibold text-white mb-3 font-mono flex items-center">
              ...
              {/* Certificates Card */}
              <Card className="bg-gray-900/90 backdrop-blur-sm border border-gray-700 hover:border-green-500/50 transition-all duration-300">
                <CardContent className="p-6">
                  <div className="flex items-center mb-6">
                    ...
                    <div>
                      <h3 className="text-xl font-bold text-white font-mono">Certificates</h3>
                      <p className="text-gray-400 font-mono text-sm">Professional Development</p>
                    </div>
                  </div>
              ...
              {/* Status Card */}
              <Card className="bg-gradient-to-r from-purple-500/10 to-pink-500/10 border border-purple-500/30 backdrop-blur-sm">
                <CardContent className="p-6">
                  <div className="flex items-center mb-4">
