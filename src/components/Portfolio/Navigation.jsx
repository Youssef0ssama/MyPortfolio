        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            {navItems.map((item) => (
              <a
                ...
                className={`font-mono font-medium transition-all duration-200 relative group ${
                  scrolled ? 'text-gray-300 hover:text-cyan-400' : 'text-gray-300 hover:text-cyan-400'
                }`}
              >
          ...
          <button
            ...
            className={`md:hidden p-2 rounded-lg transition-all duration-200 ${
              scrolled ? 'text-gray-300 hover:text-cyan-400 bg-gray-800/50' : 'text-gray-300 hover:text-cyan-400 bg-gray-800/30'
            }`}
          >
            ...
            <div className="px-6 py-4 space-y-4">
              {navItems.map((item) => (
                <a
                  ...
                  className="block text-gray-300 hover:text-cyan-400 font-mono font-medium transition-colors py-2"
                >
